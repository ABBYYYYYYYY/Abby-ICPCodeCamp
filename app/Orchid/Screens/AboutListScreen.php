    ...
    public function commandBar(): array
    {
        return [
            Link::make('Create New')
                ->icon('bs.pen')
                ->route('platform.about.background.create', ['id' => 0 ,'action' => 'create']),
        ];
    }
                ...
                [
                    ...
                    TD::make('delete', 'Delete')->render(function (AboutList $aboutList) {
                        return Button::make('Delete')
                            ->method('delete', ['aboutList' => $aboutList->id])
                    ...
                    TD::make('update', 'Update')->render(function (AboutList $aboutList) {
                        ...
                        return Link::make('Edit')
                            ->icon('bs.pen')
                            ->route('platform.about.background.update', ['id' => $aboutList->id, 'action' => 'update']);
                    })->alignRight(),
                ]
            )->title('Skills'),
