    ...
    public function commandBar(): array
    {
        return [
            Link::make('Create New')
                ->icon('bs.pen')
                ->route('platform.project.create', ['id' => 0,'action' => 'create']),
        ];
    }
                ...
                [
                    ...
                    TD::make('delete', 'Delete')->render(function (Project $projects) {
                        return Button::make('Delete')
                            ->method('delete', ['projects' => $projects->id])
                    ...
                    TD::make('update', 'Update')->render(function (Project $projects) {
                        return Link::make('Edit')
                            ->icon('bs.pen')
                            ->route('platform.project.edit', ['id' => $projects->getAttribute('id'), 'action' => 'update']);
                    })->alignRight(),
                ]
            ),
        ];
